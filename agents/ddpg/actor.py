...
class Actor:
    ...
    def build_model(self):
        ...
        raw_actions = layers.Dense(units=self.action_size, activation='sigmoid', kernel_initializer=initializers.random_uniform(minval=-0.003, maxval=0.003), name='raw_actions')(net)
